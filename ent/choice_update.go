...
func (cu *ChoiceUpdate) SetNillableQuesionID(id *uuid.UUID) *ChoiceUpdate {
	if id != nil {
		cu = cu.SetQuesionID(*id)
	}
	return cu
}
...
// SetNillableQuesionID sets the "quesion" edge to the Question entity by ID if the given value is not nil.
func (cuo *ChoiceUpdateOne) SetNillableQuesionID(id *uuid.UUID) *ChoiceUpdateOne {
	if id != nil {
		cuo = cuo.SetQuesionID(*id)
	}
	return cuo
}
